function [ run_name, run_data ] = experiment_practice( run_number, window, grey, fixationFirst, xm, ym, dstRect, theta1, theta2, sin_freq, aperature_smooth, xCenter, yCenter, imSize,deviceString, blockdur,translation)
...
repeat = round(rand(1,1000)*2+3); % list of ints between 3 and 5 (seconds between random repeating values)
repeatFlicker = round(rand(1,1000)*2+3); % list of ints between 3 and 5 (seconds between flickers)
repeat2Hz = repeat * 2;
